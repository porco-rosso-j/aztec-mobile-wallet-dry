...
export declare class BarretenbergApi {
    ...
    acirProveUltraHonk(constraintSystemBuf: Uint8Array, witnessBuf: Uint8Array): Promise<Uint8Array>;
    acirVerifyUltraHonk(proofBuf: Uint8Array, vkBuf: Uint8Array): Promise<boolean>;
    acirWriteVkUltraHonk(constraintSystemBuf: Uint8Array): Promise<Uint8Array>;
