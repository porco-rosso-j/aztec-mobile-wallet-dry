...
// 	console.log("formattedPubkey: ", formattedPubkey);
...
// 	const parsedSignature = parseAndNormalizeSig(signature);
// 	console.log("parsedSignature: ", parsedSignature);
// 	return parsedSignature;
// }

export async function parseMessage(data: string): Promise<number[]> {
