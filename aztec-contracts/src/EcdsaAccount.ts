...
export const EcdsaAccountContractArtifact = loadContractArtifact(EcdsaAccountContractArtifactJson as NoirCompiledContract);
...
export class EcdsaAccountContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]) {
    return new DeployMethod<EcdsaAccountContract>(Fr.ZERO, wallet, EcdsaAccountContractArtifact, EcdsaAccountContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeysHash(publicKeysHash: Fr, wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]) {
    return new DeployMethod<EcdsaAccountContract>(publicKeysHash, wallet, EcdsaAccountContractArtifact, EcdsaAccountContract.at, Array.from(arguments).slice(2));
  }
