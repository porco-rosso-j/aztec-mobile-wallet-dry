...
export function hexToBytes(hex) {
    ...
    return ((_a = formattedHex.match(/.{1,2}/g)) === null || _a === void 0 ? void 0 : _a.map(byte => parseInt(byte, 16))) || [];
}
...
export function bigIntToBytes(int) {
    ...
    return ((_a = hex.match(/.{1,2}/g)) === null || _a === void 0 ? void 0 : _a.map(byte => parseInt(byte, 16))) || [];
}
